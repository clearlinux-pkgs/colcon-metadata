...
Source0  : https://files.pythonhosted.org/packages/83/e7/a46f45351b50c67ebc085ecbbdfe98279f794636945fb4a21d9331f4bf53/colcon-metadata-0.2.4.tar.gz
...
%prep
%setup -q -n colcon-metadata-0.2.4
cd %{_builddir}/colcon-metadata-0.2.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584058954
